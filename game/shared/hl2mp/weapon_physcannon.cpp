...
bool CWeaponPhysCannon::AttachObject( CBaseEntity *pObject, const Vector &vPosition )
{
	...
	if( !FClassnameIs( pObject, "combine_mine" ) )
	...
	if ( m_hAttachedObject && m_hAttachedObject->GetOwnerEntity() == NULL )
	{
